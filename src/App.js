    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/services/local" exact element={<Service_LocalMoving/>} />
          <Route path="/services/longDist" exact element={<Service_LongDistance/>} />
          <Route path="/services/commercial" exact element={<Service_Commercial/>} />
          <Route path="/services/packing" exact element={<Service_Packing/>} />
          <Route path="/services/storage" exact element={<Service_Storage/>} />
          <Route path="/services/delivery" exact element={<Service_Delivery/>} />
